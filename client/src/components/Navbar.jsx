  ...
  return(
    <nav className='w-full flex md:justify-center justify-between items-center p-4'>
      ...
      <ul className='text-white md:flex hidden list-none flex-row justify-between items-center flex-initial'>
        ...
        <li className='bg-[#29252e3] py-2 px-7 mx-4 rounded-full cursor-pointer hover:bg-[#2546bd]'>
          Login
        </li>
      </ul>
      <div className="flex relative">
        {toggleMenu
          ...
          : <HiMenuAlt4 className='text-white md:hidden cursor-pointer' onClick={() => setToggleMenu(true)} fontSize={28}/>
        }
        {toggleMenu && (
          <ul
